### Adapted with personal tweaks
Imager was an awesome plugin that I still use in my projects. I've created this fork just to add some tweaks, mainly to work with Gumlet and how we set things up.
